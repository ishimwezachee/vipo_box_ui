	...
	return (
		<View>
			...
			<View style={styles.LoginButtonStyle}>
				<Button text="Login into the box" onPress={() => navigation.navigate('BottomNavAgent')} />
				{/* <Button text="Client" onPress={() => navigation.navigate('BottomNav')} />
				<Button text="Agent" onPress={onPress} />
				<Button text="Point" onPress={onPress} /> */}
